# START OF FILE FunPayCortex-main/locales/uk.py
...
✅ Працює трохи швидше.
❌ <i>FPCortex</i> бачить лише останнє повідомлення. Якщо надійде кілька повідомлень поспіль – побачить лише останнє.
...
proxy_adding_error = "⚠️ Помилка під час додавання проксі."
proxy_undeletable = "❌ Цей проксі використовується і не може бути видалений."
...
power_off_3 = """Не наполягаю, але якщо потрібно застосувати зміни основного конфіга,
...
gf_name_invalid = "🚫 Неприпустиме ім'я файлу.\n\n" \
                  "Дозволено лише <b><u>англійські</u></b> " \
...
desc_ad = "Налаштування автовидачі: прив'язка до лотів, управління файлами товарів тощо."
...
exc_cfg_parse_err = "Помилка в конфізі {}, секція [{}]: {}"
...
file_info_downloading = "⏬ Завантажую файл із серверів Telegram..."
...
file_err_processing_generic = "⚠️ Сталася помилка під час обробки файлу: <code>{error_message}</code>"
...
image_upload_chat_success_info = "Використовуйте цей ID у текстах автовидачі або автовідповіді зі змінною <code>$photo</code>.\n\nНаприклад: <code>$photo={image_id}</code>"
