...
pl_delete_handler_failed = "⚠️ Помилка при виконанні обробника видалення плагіна «{plugin_name}». Плагін видалено зі списку, але його дані або файли могли залишитися. Перевірте логи."
...
proxy_status_enabled = "Увімкнено"
proxy_status_disabled = "Вимкнено"
...
proxy_selected_and_applied = "✅ Проксі {proxy_str} вибрано і застосовано."
...
access_granted = "Доступ відкрито! 🔓\n\n" \
                 "📢 Зверни увагу: сповіщення в <b><u>цей чат</u></b> поки не надходять.\n\n" \
...
param_disabled = "❌ Це налаштування вимкнено глобально і не може бути змінено для цього лота.\n\n" \
...
❌ Чат стає "прочитаним" (не світиться помаранчевим), оскільки <i>FPCortex</i> читає всю історію.
...
❌ <i>FPCortex</i> не завжди точно визначає автора. Якщо чат не прочитано – повідомлення від співрозмовника, інакше – від тебе. Ця логіка може давати збої. Арбітраж також не буде визначено.

💡 Якщо натиснути кнопку <code>Детальніше</code> у сповіщенні, <i>FPCortex</i> "прочитає" чат, покаже останні 15 повідомлень (включно з картинками) і зможе точно визначити автора."""
...
update_backup = "✅ Створено резервну копію (конфіги, сховище, плагіни): <code>backup.zip</code>.\n\n" \
                "🔒 <b>ВАЖЛИВО:</b> НЕ НАДСИЛАЙТЕ цей архів НІКОМУ. Він містить усі дані та налаштування бота (включно з golden_key та товарами)."
...
cfg_main = "Основний конфіг. 🔒 ВАЖЛИВО: НЕ НАДСИЛАЙТЕ цей файл НІКОМУ."
...
📦 Автодеактивація (якщо товари закінчились)
🔝 Завжди онлайн
📲 Telegram-сповіщення
...
desc_au = "Налаштування авторизації користувачів в панелі керування Telegram."
...
cmd_balance = "переглянути баланс акаунта"
...
log_review_reply_changed = "$MAGENTA@{} (ID: {})$RESET змінив текст відповіді на відгук з {} зв. на $YELLOW{}$RESET."
...
log_sending_greetings = "Користувач $YELLOW{} (CID: {})$RESET написав уперше! Надсилаю вітальне повідомлення..."
...
# Дублікати з кінця оригінального файлу. Перекладаю їх також.
acc_balance_available = "доступно"
gf_infinity = "нескінченно"
gf_count_error = "помилка підрахунку"
gf_file_not_found_short = "не знайдено"
