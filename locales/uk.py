...
ar_default_response_text = "Відповідь для цієї команди ще не налаштована. Відредагуйте її."
...
gf_already_deleted = "Файл {file_name} вже було видалено."
...
oc_send_reply = "{} Відправляти відповідь"
...
cfg_download_ar = "📥 Конфіг автовідповідача"
cfg_download_ad = "📥 Конфіг автовидачі"
cfg_upload_main = "📤 Основний конфіг"
cfg_upload_ar = "📤 Конфіг автовідповідача"
...
proxy_select_error_not_found = "⚠️ Помилка: цей проксі більше не існує в списку."
...
proxy_delete_error_not_found = "⚠️ Помилка: проксі для видалення не знайдено в списку."
...
💡 Якщо натиснути кнопку <code>Детальніше</code> в сповіщенні, <i>FPCortex</i> "прочитає" чат, покаже останні 15 повідомлень (включаючи картинки) і зможе точно визначити автора."""
...
user_blacklisted = "✅ Користувач <code>{}</code> доданий до чорного списку."
...
proxy_format = "❌ Невірний формат проксі. Потрібен: <u>login:password@ip:port</u> або <u>ip:port</u>."
...
# Оновлені рядки для системи оновлень
...
update_download_error = "⚠️ Помилка при завантаженні архіву оновлення."
...
update_done_exe = "✅ Оновлення встановлено! Новий <code>FPCortex.exe</code> знаходиться в папці <code>update</code>. " \
                  ...
                  "та запустіть <code>Start.bat</code>."
...
ad_link_gf = "Введи назву файлу з товарами.\nЩоб відв'язати файл, надішли <code>-</code>\n\n" \
             "Якщо файлу немає, його буде створено автоматично."
...
gf_new_goods = "✅ Додано <code>{}</code> товар(а/ів) до файлу <code>storage/products/{}</code>."
...
desc_ad = "Налаштування автовидачі: прив'язка до лотів, управління файлами товарів і т.д."
...
desc_ad_fp_lot_list = "Список лотів з твого профілю FunPay. Вибери лот, щоб налаштувати автовидачу.\n" \
                      ...
                      "Останнє сканування: {}"
desc_gf = "Вибери файл товарів для управління:"
...
desc_proxy = "Управління проксі-серверами для роботи бота."

# - Опис команд
cmd_menu = "відкрити головне меню"
cmd_language = "змінити мову інтерфейсу"
cmd_profile = "переглянути статистику акаунта"
...
log_notification_switched = "$MAGENTA@{} (ID: {})$RESET переключив сповіщення $YELLOW{}$RESET для чату $YELLOW{}$RESET на $CYAN{}$RESET."
...
log_gf_new_goods = "$MAGENTA@{} (ID: {})$RESET додав $CYAN{}$RESET товар(-а, -ів) до файлу $YELLOWstorage/products/{}$RESET."
...
log_sending_greetings = "Користувач $YELLOW{} (CID: {})$RESET написав вперше! Надсилаю привітальне повідомлення..."
...
# acc_balance_available = "доступно" (вже є)
# gf_infinity = "нескінченно" (вже є)
# gf_count_error = "помилка підрахунку" (вже є)
# gf_file_not_found_short = "не знайдено" (вже є)
# gf_not_linked = "не прив'язано" (вже є)
# gf_file_created_now = "створено" (вже є)
# gf_file_creation_error_short = "помилка створення" (вже є)
# no_lots_using_file = "Жоден лот не використовує цей файл." (вже є)
# gf_no_products_to_add = "Не було введено товарів для додавання." (вже є)
# gf_deleted_successfully = "Файл {file_name} успішно видалено." (вже є)
# gf_already_deleted = "Файл {file_name} вже було видалено." (вже є)
# ar_no_valid_commands_entered = "Не введено жодної коректної команди." (вже є)
# ar_default_response_text = "Відповідь для цієї команди ще не налаштована. Відредагуйте її." (вже є)
# ar_default_notification_text = "Користувач $username ввів команду: $message_text" (вже є)
# ar_command_deleted_successfully = "Команду/сет '{command_name}' успішно видалено." (вже є)
...
file_err_wrong_format = "❌ Невірний формат файлу: <b><u>.{actual_ext}</u></b> (очікувався <b><u>.{expected_ext}</u></b>)."
...
# pl_status_active = "Статус: Активний 🚀" (вже є)
# pl_status_inactive = "Статус: Неактивний 💤" (вже є)
# pl_no_commands = "У цього плагіна немає зареєстрованих команд." (вже є)
# pl_delete_handler_failed = "⚠️ Помилка під час виконання обробника видалення плагіна '{plugin_name}'. Плагін видалено зі списку, але його дані або файли могли залишитися. Перевірте логи." (вже є)
# pl_deleted_successfully = "✅ Плагін '{plugin_name}' успішно видалено. Перезапустіть FPCortex, щоб зміни набули чинності." (вже є)
# pl_file_delete_error = "⚠️ Не вдалося видалити файл плагіна '{plugin_path}'. Перевірте права доступу та логи." (вже є)
# proxy_status_enabled = "Увімкнені" (вже є)
# proxy_status_disabled = "Вимкнені" (вже є)
# proxy_check_status_enabled = "Увімкнена" (вже є)
# proxy_check_status_disabled = "Вимкнена" (вже є)
# proxy_not_used_currently = "не використовується" (вже є)
# proxy_not_selected = "не вибрано" (вже є)
# proxy_check_interval_info = "Інтервал авто-перевірки: {interval} хв." (вже є)
# proxy_global_status_header = "Загальний статус проксі-модуля" (вже є)
# proxy_module_status_label = "Стан модуля:" (вже є)
# proxy_health_check_label = "Авто-перевірка проксі:" (вже є)
# proxy_current_in_use_label = "Поточний проксі в роботі:" (вже є)
# proxy_select_error_not_found = "⚠️ Помилка: цей проксі більше не існує в списку." (вже є)
# proxy_select_error_invalid_format = "⚠️ Помилка: вибраний проксі має невірний формат." (вже є)
# proxy_selected_and_applied = "✅ Проксі {proxy_str} вибрано та застосовано." (вже є)
# proxy_selected_not_applied = "ℹ️ Проксі {proxy_str} вибрано. Увімкніть модуль проксі в налаштуваннях, щоб він почав використовуватися." (вже є)
# proxy_deleted_successfully = "✅ Проксі {proxy_str} успішно видалено зі списку." (вже є)
# proxy_delete_error_not_found = "⚠️ Помилка: проксі для видалення не знайдено в списку." (вже є)
# tmplt_editing_header = "📝 Редагування шаблону" (вже є)
# tmplt_err_empty_text = "❌ Текст шаблону не може бути порожнім. Будь ласка, введіть текст." (вже є)
# tmplt_deleted_successfully = "✅ Шаблон «{template_text}» успішно видалено." (вже є)
