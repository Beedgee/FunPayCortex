...
# multi
mm_accounts = "👤 Акаунти"
acc_list_header = "Список ваших акаунтів FunPay:"
acc_select = "Обрати"
acc_selected = "Обрано ✅"
acc_status_online = "В мережі"
acc_status_offline = "Не в мережі"
acc_status_error = "Помилка"
acc_toggle_on = "Увімкнути"
acc_toggle_off = "Вимкнути"
acc_add = "➕ Додати акаунт"
acc_delete = "🗑️ Видалити"
acc_deleted_success = "Акаунт {name} видалено. Перезапустіть бота."
acc_toggled_on = "Акаунт {name} увімкнено. Перезапустіть бота, щоб зміни набули чинності."
acc_toggled_off = "Акаунт {name} вимкнено. Перезапустіть бота, щоб зміни набули чинності."
acc_selected_success = "Активний акаунт змінено на {name}."
acc_prompt_name = "Введіть унікальне ім'я для нового акаунта (наприклад, VovaMain):"
acc_prompt_token = "Тепер введіть golden_key для акаунта {name}:"
acc_err_name_exists = "Акаунт з таким ім'ям вже існує."
acc_err_token_invalid = "Неправильний формат golden_key."
acc_add_success = "Акаунт {name} успішно додано. Перезапустіть бота, щоб він почав працювати."
acc_delete_confirm = "Ви впевнені, що хочете видалити акаунт {name}? Ця дія незворотна."
no_active_fp_account = "⚠️ У вас не вибрано активний акаунт FunPay або немає доступних акаунтів. Оберіть акаунт у меню /menu -> 👤 Акаунти."