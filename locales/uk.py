...
oc_notify_pending_execution_msg = "⚠️ Замовлення <code>#{order_id}</code> від <code>{username}</code> очікує на вашу увагу вже більше {} хвилин!"
oc_notify_pending_confirmation_msg = "🔔 Покупець <code>{username}</code> не підтверджує замовлення <code>#{order_id}</code> вже більше {} годин. Можливо, варто йому нагадати."
