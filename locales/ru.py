...
gl_refresh_and_try_again = "Обновите список и попробуйте снова." # Для auto_delivery_cp.py
...
ar_no_valid_commands_entered = "Не введено ни одной корректной команды." # Для auto_response_cp.py
ar_default_response_text = "Ответ для этой команды еще не настроен. Отредактируйте его." # Для auto_response_cp.py
ar_default_notification_text = "Пользователь $username ввел команду: $message_text" # Для auto_response_cp.py
ar_command_deleted_successfully = "Команда/сет '{command_name}' успешно удалена." # Для auto_response_cp.py
...
# ad_to_mm уже есть выше
never_updated = "никогда" # Для auto_delivery_cp.py (время последнего обновления списка лотов FunPay)
...
lot_info_header = "Информация о лоте" # Для utils.py -> generate_lot_info_text
text_not_set = "(текст не задан)" # Для utils.py -> generate_lot_info_text
gf_infinity = "бесконечно" # Для utils.py -> generate_lot_info_text
gf_count_error = "ошибка подсчета" # Для utils.py -> generate_lot_info_text
gf_file_not_found_short = "не найден" # Для utils.py -> generate_lot_info_text
gf_not_linked = "не привязан" # Для utils.py -> generate_lot_info_text
gf_file_created_now = "создан" # Для utils.py -> generate_lot_info_text (Когда файл только что создан утилитой)
gf_file_creation_error_short = "ошибка создания" # Для utils.py -> generate_lot_info_text
no_lots_using_file = "Ни один лот не использует этот файл." # Для auto_delivery_cp.py
gf_no_products_to_add = "Не было введено товаров для добавления." # Для auto_delivery_cp.py
gf_deleted_successfully = "Файл {file_name} успешно удален." # Для auto_delivery_cp.py
gf_already_deleted = "Файл {file_name} уже был удален." # Для auto_delivery_cp.py
...
tmplt_editing_header = "📝 Редактирование шаблона" # Для templates_cp.py
tmplt_err_empty_text = "❌ Текст шаблона не может быть пустым. Пожалуйста, введите текст." # Для templates_cp.py
tmplt_deleted_successfully = "✅ Шаблон «{template_text}» успешно удален." # Для templates_cp.py
...
pl_status_active = "Статус: Активен 🚀" # Для plugins_cp.py
pl_status_inactive = "Статус: Неактивен 💤" # Для plugins_cp.py
pl_no_commands = "У этого плагина нет зарегистрированных команд." # Для plugins_cp.py
pl_delete_handler_failed = "⚠️ Ошибка при выполнении обработчика удаления плагина '{plugin_name}'. Плагин удален из списка, но его данные или файлы могли остаться. Проверьте логи." # Для plugins_cp.py
pl_deleted_successfully = "✅ Плагин '{plugin_name}' успешно удален. Перезапустите FPCortex, чтобы изменения вступили в силу." # Для plugins_cp.py
pl_file_delete_error = "⚠️ Не удалось удалить файл плагина '{plugin_path}'. Проверьте права доступа и логи." # Для plugins_cp.py

# Конфиги
cfg_download_main = "📥 Основной конфиг"
cfg_download_ar = "📥 Конфиг автоответа"
cfg_download_ad = "📥 Конфиг автовыдачи"
cfg_upload_main = "📤 Основной конфиг"
cfg_upload_ar = "📤 Конфиг автоответа"
...
proxy_status_enabled = "Включены" # Для proxy_cp.py
proxy_status_disabled = "Выключены" # Для proxy_cp.py
proxy_check_status_enabled = "Включена" # Для proxy_cp.py
proxy_check_status_disabled = "Выключена" # Для proxy_cp.py
proxy_not_used_currently = "не используется" # Для proxy_cp.py
proxy_not_selected = "не выбран" # Для proxy_cp.py
proxy_check_interval_info = "Интервал авто-проверки: {interval} мин." # Для proxy_cp.py
proxy_global_status_header = "Общий статус прокси-модуля" # Для proxy_cp.py
proxy_module_status_label = "Состояние модуля:" # Для proxy_cp.py
proxy_health_check_label = "Авто-проверка прокси:" # Для proxy_cp.py
proxy_current_in_use_label = "Текущий прокси в работе:" # Для proxy_cp.py
proxy_select_error_not_found = "⚠️ Ошибка: этот прокси больше не существует в списке." # Для proxy_cp.py
proxy_select_error_invalid_format = "⚠️ Ошибка: выбранный прокси имеет неверный формат." # Для proxy_cp.py
proxy_selected_and_applied = "✅ Прокси {proxy_str} выбран и применен." # Для proxy_cp.py
proxy_selected_not_applied = "ℹ️ Прокси {proxy_str} выбран. Включите модуль прокси в настройках, чтобы он начал использоваться." # Для proxy_cp.py
proxy_deleted_successfully = "✅ Прокси {proxy_str} успешно удален из списка." # Для proxy_cp.py
proxy_delete_error_not_found = "⚠️ Ошибка: прокси для удаления не найден в списке." # Для proxy_cp.py

# Ссылки
# Убраны согласно требованию

# Объявления (Отключены)
an_an = "{} Объявления"
an_ad = "{} Реклама"
...
update_no_tags = "❌ Не удалось получить список версий. Попробуй позже. (Обновления отключены)"
update_lasted = "✅ У тебя последняя версия FPCortex {} (Обновления отключены)"
update_get_error = "❌ Не удалось получить информацию о новой версии. Попробуй позже. (Обновления отключены)"
update_available = "<b>✨ Доступна новая версия! ✨</b>\n\n\n{}\n\n{}"
update_update = "Для обновления введи команду /update (Обновления отключены)"
update_backup = "✅ Создана резервная копия (конфиги, хранилище, плагины): <code>backup.zip</code>.\n\n" \
                "🔒 <b>ВАЖНО:</b> НЕ ОТПРАВЛЯЙ этот архив НИКОМУ. Он содержит все данные и настройки бота (включая golden_key и товары)."
update_backup_error = "⚠️ Не удалось создать резервную копию."
update_backup_not_found = "❌ Резервная копия не найдена."
update_downloaded = "✅ Загружено обновление {} (пропущено {} элементов). Устанавливаю... (Обновления отключены)"
update_download_error = "⚠️ Ошибка при загрузке обновления."
update_done = "✅ Обновление установлено! Перезапусти <i>FPCortex</i> командой /restart (Обновления отключены)"
update_done_exe = "✅ Обновление установлено! Новый <code>FPCortex.exe</code> в папке <code>update</code>. " \
                  "Выключи <i>FPCortex</i>, замени старый <code>FPCortex.exe</code> новым " \
                  "и запусти <code>Start.bat</code>. (Обновления отключены)"
...
# profile_header_title = "Статистика аккаунта" # Уже есть как cmd_profile, но можно сделать отдельный
...
# Логи (оставляем как есть, т.к. это для разработчика, а не пользователя)
...
# Новые ключи, добавленные в процессе редизайна:

# Для utils.py -> generate_profile_text
# profile_header_title = "Статистика аккаунта" # Уже есть как cmd_profile, но можно сделать отдельный
# acc_balance_available = "доступно" # Уже есть выше

# Для utils.py -> generate_lot_info_text
# lot_info_header = "Информация о лоте" # Уже есть выше
# text_not_set = "(текст не задан)" # Уже есть выше
# gf_infinity = "бесконечно" # Уже есть выше
# gf_count_error = "ошибка подсчета" # Уже есть выше
# gf_file_not_found_short = "не найден" # Уже есть выше
# gf_not_linked = "не привязан" # Уже есть выше
# gf_file_created_now = "создан" # Уже есть выше (Когда файл только что создан утилитой)
# gf_file_creation_error_short = "ошибка создания" # Уже есть выше

# Для auto_delivery_cp.py
# never_updated = "никогда" # Уже есть выше (Для времени последнего обновления списка лотов FunPay)
# ad_default_response_text_new_lot = "Спасибо за покупку, $username!\nВот твой товар:\n$product" # Уже есть выше
# no_lots_using_file = "Ни один лот не использует этот файл." # Уже есть выше
# gf_no_products_to_add = "Не было введено товаров для добавления." # Уже есть выше
# gl_refresh_and_try_again = "Обновите список и попробуйте снова." # Уже есть выше
# gf_deleted_successfully = "Файл {file_name} успешно удален." # Уже есть выше
# gf_already_deleted = "Файл {file_name} уже был удален." # Уже есть выше

# Для auto_response_cp.py
# ar_no_valid_commands_entered = "Не введено ни одной корректной команды." # Уже есть выше
# ar_default_response_text = "Ответ для этой команды еще не настроен. Отредактируйте его." # Уже есть выше
# ar_default_notification_text = "Пользователь $username ввел команду: $message_text" # Уже есть выше
# ar_command_deleted_successfully = "Команда/сет '{command_name}' успешно удалена." # Уже есть выше
...
plugin_uploaded_success = "✅ Плагин <code>{filename}</code> успешно загружен.\n\n⚠️ Чтобы плагин заработал, <b><u>перезагрузите FPCortex</u></b> командой /restart!"
...
products_file_provide_prompt = "📎 Отправьте мне файл с товарами (в формате .txt):"
products_file_upload_success = "✅ Файл с товарами <code>{filepath}</code> успешно загружен.\nКоличество товаров в файле: <code>{count}</code>."
products_file_count_error = "⚠️ Произошла ошибка при подсчете товаров в загруженном файле. Файл загружен, но проверьте его содержимое."
...
# Для plugins_cp.py
# pl_status_active = "Статус: Активен 🚀" # Уже есть выше
# pl_status_inactive = "Статус: Неактивен 💤" # Уже есть выше
# pl_no_commands = "У этого плагина нет зарегистрированных команд." # Уже есть выше
# pl_delete_handler_failed = "⚠️ Ошибка при выполнении обработчика удаления плагина '{plugin_name}'. Плагин удален из списка, но его данные или файлы могли остаться. Проверьте логи." # Уже есть выше
# pl_deleted_successfully = "✅ Плагин '{plugin_name}' успешно удален. Перезапустите FPCortex, чтобы изменения вступили в силу." # Уже есть выше
# pl_file_delete_error = "⚠️ Не удалось удалить файл плагина '{plugin_path}'. Проверьте права доступа и логи." # Уже есть выше

# Для proxy_cp.py
# proxy_status_enabled = "Включены" # Уже есть выше
# proxy_status_disabled = "Выключены" # Уже есть выше
# proxy_check_status_enabled = "Включена" # Уже есть выше
# proxy_check_status_disabled = "Выключена" # Уже есть выше
# proxy_not_used_currently = "не используется" # Уже есть выше
# proxy_not_selected = "не выбран" # Уже есть выше
# proxy_check_interval_info = "Интервал авто-проверки: {interval} мин." # Уже есть выше
# proxy_global_status_header = "Общий статус прокси-модуля" # Уже есть выше
# proxy_module_status_label = "Состояние модуля:" # Уже есть выше
# proxy_health_check_label = "Авто-проверка прокси:" # Уже есть выше
# proxy_current_in_use_label = "Текущий прокси в работе:" # Уже есть выше
# proxy_select_error_not_found = "⚠️ Ошибка: этот прокси больше не существует в списке." # Уже есть выше
# proxy_select_error_invalid_format = "⚠️ Ошибка: выбранный прокси имеет неверный формат." # Уже есть выше
# proxy_selected_and_applied = "✅ Прокси {proxy_str} выбран и применен." # Уже есть выше
# proxy_selected_not_applied = "ℹ️ Прокси {proxy_str} выбран. Включите модуль прокси в настройках, чтобы он начал использоваться." # Уже есть выше
# proxy_deleted_successfully = "✅ Прокси {proxy_str} успешно удален из списка." # Уже есть выше
# proxy_delete_error_not_found = "⚠️ Ошибка: прокси для удаления не найден в списке." # Уже есть выше

# Для templates_cp.py
# tmplt_editing_header = "📝 Редактирование шаблона" # Уже есть выше
# tmplt_err_empty_text = "❌ Текст шаблона не может быть пустым. Пожалуйста, введите текст." # Уже есть выше
# tmplt_deleted_successfully = "✅ Шаблон «{template_text}» успешно удален." # Уже есть выше
