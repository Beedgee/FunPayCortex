...
# Глобальные
gl_next = "Далее ▶️" # Изменено для единообразия
gl_back = "Назад ◀️"
gl_yes = "Да ✅"
gl_yep = "Ага ✅"
gl_no = "Нет ❌"
...
fpc_init = """✅ <b><u>FPCortex иніціалізовано!</u></b> # Ой, это для украинского, исправлю
...
# Исправленный fpc_init для русского:
...
👨‍💻 <b><i>Автор:</i></b> @beedge""" # Добавил свое имя
...
<code>!автовыдача {}</code>""" # Убрал FunPay Cortex из команды
...
# Обновленные строки для системы обновлений
...
crd_raise_wait_3600 = "Следующая попытка через {}." # Старое название, но смысл тот же
