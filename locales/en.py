...
gs_keep_sent_messages_unread = "{} Не позначати прочитаним при відправленні"
...
access_granted = "Доступ відкрито! 🔓\n\n" \
                 "📢 Зверни увагу: сповіщення в <b><u>цей чат</u></b> поки що не надходять.\n\n" \
...
⏳ <i>FPCortex</i> <b><u>поки що не ініціалізовано</u></b>, його функції неактивні.
...
v_sleep = "<code>$sleep=[СЕКУНДИ]</code> - затримка перед відправленням (наприклад, $sleep=2)"
