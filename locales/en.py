...
acc_list_header = "List of your FunPay accounts:"
acc_select = "Select"
acc_selected = "Selected ✅"
acc_status_online = "Online"
acc_status_offline = "Offline"
acc_status_error = "Error"
acc_toggle_on = "Enable"
acc_toggle_off = "Disable"
acc_add = "➕ Add Account"
acc_delete = "🗑️ Delete"
acc_deleted_success = "Account {name} has been deleted. Please restart the bot."
acc_toggled_on = "Account {name} has been enabled. Restart the bot for changes to take effect."
acc_toggled_off = "Account {name} has been disabled. Restart the bot for changes to take effect."
acc_selected_success = "Active account changed to {name}."
acc_prompt_name = "Enter a unique name for the new account (e.g., VovaMain):"
acc_prompt_token = "Now enter the golden_key for the account {name}:"
acc_err_name_exists = "An account with this name already exists."
acc_err_token_invalid = "Invalid golden_key format."
acc_add_success = "Account {name} has been successfully added. Restart the bot to make it active."
acc_delete_confirm = "Are you sure you want to delete the account {name}? This action cannot be undone."
no_active_fp_account = "⚠️ You have no active FunPay account selected or no accounts available. Please select one in /menu -> 👤 Accounts."