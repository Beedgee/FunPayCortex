# START OF FILE FunPayCortex-main/locales/en.py
...
gs_autodisable = "{} Auto-disable lots"
...
# Blacklist Settings
bl_autodelivery = "{} Don't deliver product"
bl_autoresponse = "{} Don't reply to commands"
...
manager_settings_desc = "Here you can set a registration key for your managers. They will be able to use the bot with limited rights.\n\n<b>Current key:</b> {}"
manager_key_not_set = "<i>(not set)</i>"
set_manager_key_btn = "🔑 Change Key"
enter_manager_key_prompt = "Enter a new key for manager registration. To delete the key, send <code>-</code>."
...
demote_last_admin_error = "❌ Cannot demote the last administrator."
user_not_found = "User not found."
admin_only_command = "❌ This command is only available to the administrator."
...
proxy_selected_not_applied = "ℹ️ Proxy {proxy_str} has been selected. Enable the proxy module in the settings for it to be used."
proxy_deleted_successfully = "✅ Proxy {proxy_str} has been successfully removed from the list."
proxy_delete_error_not_found = "⚠️ Error: proxy for deletion was not found in the list."
...
🔑 Enter the <u><b>secret password</b></u> (for admin) or the <u><b>registration key</b></u> (for manager) to log in.
...
❌ The chat becomes "read" (no longer highlighted in orange) because <i>FPCortex</i> reads the entire history.
...
❌ <i>FPCortex</i> does not always accurately identify the author. If the chat is unread, the message is from the interlocutor; otherwise, it's from you. This logic can fail. Arbitration will also not be identified.

💡 If you press the <code>Details</code> button in a notification, <i>FPCortex</i> will "read" the chat, show the last 15 messages (including images), and be able to accurately identify the author."""
bot_started = """✅ Telegram bot started!
You can <b><u>configure configs</u></b> and <b><u>use all Telegram bot functions</u></b>.
...
test_ad_key_created = """✅ A one-time key has been created for the lot "<code>{}</code>".
...
update_no_tags = "❌ Failed to get list of versions from GitHub. Please try again later."
...
power_off_1 = "One more time, just in case... <b><u>Are you sure about turning me off?</u></b> 😟"
...
ad_already_ad_err = "⚠️ Lot <code>{}</code> already has auto-delivery configured."
...
ad_updating_lots_list = "Updating data on lots and categories... ⏳"
ad_lots_list_updating_err = "⚠️ Failed to update data on lots and categories."
gf_not_found_err = "⚠️ Product file with index <code>{}</code> not found."
copy_lot_name = "Send the exact name of the lot (as on FunPay)."
...
gf_new_goods = "✅ Added <code>{}</code> product(s) to the file <code>storage/products/{}</code>."
...
desc_gs = "Here you can enable and disable the main functions of <i>FPCortex</i>."
...
desc_ar_list = "Select a command or set of commands to edit:"
...
v_edit_greeting_text = "Enter the welcome message text:"
v_edit_greeting_cooldown = "Enter the cooldown for the greeting (in days, e.g., 0.5 for 12 hours):"
...
v_edit_delivery_text = "Enter the new text for auto-delivery:"
...
log_access_attempt = "$MAGENTA@{} (ID: {})$RESET attempted to access the CP. Holding them back as best I can!"
log_manager_access_granted = "$YELLOW[MANAGER]$RESET $MAGENTA@{} (ID: {})$RESET gained access to the CP."
log_click_attempt = "$MAGENTA@{} (ID: {})$RESET is pressing CP buttons in chat $MAGENTA@{} (ID: {})$RESET. They will not succeed!"
log_access_granted = "$MAGENTA@{} (ID: {})$RESET gained access to the CP."
...
log_greeting_cooldown_changed = "$MAGENTA@{} (ID: {})$RESET changed the welcome message cooldown to $YELLOW{}$RESET days."
...
log_gf_linked = "$MAGENTA@{} (ID: {})$RESET linked product file $YELLOWstorage/products/{}$RESET to lot $YELLOW{}$RESET."
log_gf_created_and_linked = "$MAGENTA@{} (ID: {})$RESET created and linked product file $YELLOWstorage/products/{}$RESET to lot $YELLOW{}$RESET."
...
log_sending_greetings = "User $YELLOW{} (CID: {})$RESET wrote for the first time! Sending welcome message..."
...
ntfc_new_order_not_in_cfg = "ℹ️ Product will not be delivered as auto-delivery is not linked to the lot."
ntfc_new_order_ad_disabled = "ℹ️ Product will not be delivered as auto-delivery is disabled in the global toggles."
ntfc_new_order_ad_disabled_for_lot = "ℹ️ Product will not be delivered as auto-delivery is disabled for this lot."
ntfc_new_order_user_blocked = "ℹ️ Product will not be delivered as the user is on the blacklist and auto-delivery block is enabled."
ntfc_new_order_will_be_delivered = "ℹ️ Product will be delivered shortly."
ntfc_new_review = "🔮 You received a {} for order <code>{}</code>!\n\n💬<b>Review:</b>\n<code>{}</code>{}"
ntfc_review_reply_text = "\n\n🗨️<b>Reply:</b> \n<code>{}</code>"

# Cortex Logs
crd_proxy_detected = "Proxy detected."
crd_checking_proxy = "Performing proxy check..."
crd_proxy_err = "Failed to connect to proxy. Ensure the details are entered correctly."
...
crd_getting_profile_data = "Getting data on lots and categories..."
crd_profile_get_timeout_err = "Failed to load account lot data: request timed out."
crd_profile_get_unexpected_err = "An unexpected error occurred while getting data on lots and categories."
crd_profile_get_too_many_attempts_err = "An error occurred while getting data on lots and categories: exceeded number of attempts ({})."
crd_profile_updated = "Updated information about lots $YELLOW({})$RESET and categories $YELLOW({})$RESET of the profile."
crd_tg_profile_updated = "Updated information about lots $YELLOW({})$RESET and categories $YELLOW({})$RESET of the profile (TG CP)."
...
crd_lots_raised = "All lots in category $CYAN\"{}\"$RESET have been boosted!"
...
crd_raise_loop_started = "$CYANAuto-boost loop started (this does not mean auto-boosting is enabled)."
...
crd_tg_au_err = "Failed to change the message with user information: {}. Trying without a link."
...
file_err_download_failed = "❌ An error occurred while uploading the file to the bot's server."
