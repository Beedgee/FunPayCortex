...
def load_main_config(config_path: str):
    ...
    # Set default watermark if it doesn't exist or needs update
        ...
        for param_name in values[section_name]:
            ...
            if section_name == "FunPay" and param_name == "oldMsgGetMode" and param_name not in config[section_name]:
                ...
                with open(config_path, "w", encoding="utf-8") as f:
                    ...
                    param_name not in config[section_name]:
                # This handles the old "secretKey" parameter, hashing it and renaming to "secretKeyHash"
                if "secretKey" in config[section_name]:
                    ...
                    with open(config_path, "w", encoding="utf-8") as f:
                        config.write(f)
                else: # If neither exists, maybe raise an error or set a default? For now, let check_param handle it.
                     pass
